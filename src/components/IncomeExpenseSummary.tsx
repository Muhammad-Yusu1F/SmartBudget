  ...
  return (
    <section className="flex flex-col gap-3 px-1" id="income-expense-summary">
      ...
      <div className="bg-[#ffffff] dark:bg-[#131b2e] rounded-2xl p-4 border border-gray-100 dark:border-white/5 shadow-sm hover:shadow-md transition-all duration-200 flex items-center justify-between">
        ...
        <div className="text-[10px] font-bold px-2 py-1 rounded-full bg-emerald-500/10 text-emerald-600 dark:text-emerald-400">
          Tushum
        </div>
      </div>
      ...
      <div className="bg-[#ffffff] dark:bg-[#131b2e] rounded-2xl p-4 border border-gray-100 dark:border-white/5 shadow-sm hover:shadow-md transition-all duration-200 flex items-center justify-between">
        ...
        <div className="text-[10px] font-bold px-2 py-1 rounded-full bg-rose-500/10 text-rose-600 dark:text-rose-400">
          Xarajat
        </div>
      </div>
    </section>
